...
function popUpDiv (id) {
  ...
  let divLiveBtn = document.createElement('a');
  let divSourceBtn = document.createElement('a');
  let divParagraph = document.createElement('p');
  let divImage = document.createElement('img');
  let divTech = document.createElement('div');
  let divExitBtn = document.createElement('img');
  ...
  document.body.appendChild(mainDiv);
   ...
   let card1Heading = document.createElement('h3');
    card1Heading.textContent = 'Profesional Art Printing Data'
   let card1Paragraph  = document.createElement('p');
    ...
    let card1Btn = document.createElement('div');
    ...
    let card1Btn2 = document.createElement('button')
    ...
    let card2Heading = document.createElement('h3');
    ...
    let card2Btn2 = document.createElement('button')
      ...
      //  card2Btn2.setAttribute('type: button')
       ...
       card3.className = 'project-section-img3';
       let card3Heading = document.createElement('h3');
       card3Heading.textContent = 'Website Portfolio'
       let card3Paragraph  = document.createElement('p');
    ...
    let card4Heading = document.createElement('h3');
    card4Heading.textContent = 'Profesional Art Printing Data'
    let card4Paragraph  = document.createElement('p');
    ...
    let card5Heading = document.createElement('h3');
     card5Heading.textContent = 'Dashboard Healthcare'
    let card5Paragraph  = document.createElement('p');
    ...
    let card6Heading = document.createElement('h3');
     card6Heading.textContent = 'Website Portfolio'
    let card6Paragraph  = document.createElement('p');
    ...
    //  card6Btn.className = 'button'
     ...
     let wrapper = document.getElementById('idproject-section');
    //  console.log(wrapper)
